...
namespace Kchinkesh\LaravelSaml\Auth;

use OneLogin\Saml2\Auth as OneLogin_Saml2_Auth;
use OneLogin\Saml2\Error as OneLogin_Saml2_Error;
use Kchinkesh\LaravelSaml\Events\SamlLogoutEvent;
...
class SamlAuth
{
     ...
     * Pass the returned value to the SamlAuth constructor.
     * 
    ...
    public static function loadOneLoginAuthFromIpdConfig()
    {
        ...
        $config = config('samlidp_settings');
